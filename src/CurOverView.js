...
// }
    return (
      <MDBContainer>
        <MDBRow>
          <MDBCol sm="4"> <Column title="Finished" cardData={cardArr} rerender={chapterFetch()}/></MDBCol>
          <MDBCol sm="4"> <Column title="Not Finished" cardData={cardArr} rerender={chapterFetch()}/></MDBCol>
          <MDBCol sm="4"> <Column title="In Plan" cardData={cardArr} rerender={chapterFetch()}/></MDBCol>
        </MDBRow>
      </MDBContainer>
    )
}
